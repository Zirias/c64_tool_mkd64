 ...
 * self also tries to get a track from modules providing extra tracks
 * @param self the image
 ...
 * self also locates blocks on tracks from modules providing extra tracks
 * @param self the image
 ...
 * self tries to allocate a given block. A module reserving self block is asked
 ...
 * files. The Image class has a default allocator that is used if self is never
